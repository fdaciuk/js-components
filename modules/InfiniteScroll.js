;(function( window, document, $, undefined ) {
    ...
    var InfiniteScroll = function() {
        ...
        $private.handleWindowScroll = function handleWindowScroll() {
            ...
            $private.scrollTimer = window.setTimeout( $private.handleScroll, 300 );
        };
        ...
        $private.beforeInitRequest = function beforeInitRequest() {
            ...
            if( ! $private.loadingImage ) {
                ...
                $private.loadingImage.attr({ src: $private.get( 'loadingImageSrc' ) });
            }
        ...
        $private.successNextPage = function successNextPage( response ) {
            ...
            $public.set( 'nextButtonSelector', $responseNextButton[0] );
            $infiniteContainer.append( $responseItems );
